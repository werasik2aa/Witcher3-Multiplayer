...
class CPlayerInput 
{
	...
	public saved var W3MP_STORAGE: MP_STORAGE; // Storage
	public var buffer: MP_STORAGE; // Storage
	public saved var W3MP_NPCSTORAGE: MP_NPCSTORAGE; // Storage
	public saved var W3MP_PLAYERSTORAGE: MP_NPCSTORAGE; // Storage
