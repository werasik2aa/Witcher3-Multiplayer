...
namespace Witcher3_Multiplayer
{
    public static class langproc
    {
        ...
        public static int SendDataDelayToGame = 16;
        public static int SendDataDelayC_S_C = 2;
        ...
        public static Dictionary<int, CombatTarget> CombatTargetsClient = new Dictionary<int, CombatTarget>();
        public static Dictionary<int, CombatTarget> CombatTargetsClientDEAD = new Dictionary<int, CombatTarget>();
